...
class RGBDImageMerger(Node):
    ...
    def images_callback(self, msg):
        try:
            ...
            color_image1 = self.bridge.imgmsg_to_cv2(
                msg.rgbd_images[0].rgb, desired_encoding="bgr8"
            )
            color_image2 = self.bridge.imgmsg_to_cv2(
                msg.rgbd_images[1].rgb, desired_encoding="bgr8"
            )
            ...
            merged_frame = self.bridge.cv2_to_imgmsg(
                combined_color_frame, encoding="bgr8"
            )
